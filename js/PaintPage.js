$(document).ready(function () {
  ...
  var dialog_intro = [
    ...
    ["十七世紀荷蘭畫家扬·弗美尔的作品。畫作以少女戴著的珍珠耳環作為視角的焦點，現時畫作存放在海牙的毛里茨住宅中。基本上，對弗美尔本人或者他的作品，後人所知的都不多。畫作署名「IVMeer」，但沒有日期。沒有人知道這幅畫作的代理權誰屬，甚至不知道作者有沒有交付過代理權給任何人。近年有專家指出此畫作可能是一幅「tronie」，即17世紀的荷蘭流行的頭像，而這種頭像嚴格而言算不上是一幅畫作。於1994年的修復後，畫作精密的顏色運用及畫中少女對其觀察者的親密目光更被專家所留意。",
